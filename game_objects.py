...
from effects import BgStar, Explosion, TakeDamage
...
class Bullet(Sprite):
    def __init__(self, pos, angle=0):
        super().__init__()
        self.images = [
            load_and_resize("imgs/effects/bullet_0000.png", (30, 30), angle),
            load_and_resize("imgs/effects/bullet_0002.png", (30, 30), angle)
        ]
...
class Gun(Sprite):
    image = load_and_resize("imgs/enemies/gun_01.png", (100, 100))
    rect = image.get_rect()
...
class Item(Sprite):
    def __init__(self, pos=Vector2(0, 0), callback=None):
        super().__init__()
        self.image = load_and_resize("imgs/ui/life.png", (30, 30))
        self.rect = self.image.get_rect()
        self.rect.center = pos
        self.speed = Vector2(0, 1)
...
class Board(Sprite):
    def __init__(self, pos=None, size=(300, 300)):
        super().__init__()
        self.image = load_and_resize("imgs/ui/grey.png", size)
